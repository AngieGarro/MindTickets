...
function ControlActions() {
	...
	this.URL_API = "https://localhost:7042/api/";
		...
		$.ajax({
			...
			error: function (jqXHR, textStatus, errorThrown) {
				...
				Swal.fire({
					...
					title: 'Oops...',
					html:  message,
					footer: 'MindTickets Client'
				})
			}							
		});
	};
	//API LOGIN
	this.PostToAPILogin = function (service) {
			...
			success: function (data) {
				...
				switch (data) {
					...
					default:
						...
						alert("Clave o Email incorrectos")

				}
				//responseText = data;
				// Display welcome message or perform other actions with the response data
			},
			error: function (jqXHR, textStatus, errorThrown) {
